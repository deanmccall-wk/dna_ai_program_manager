...
4. Before recommending contractor load, read `shared/org.md`. Dean’s contractors are Employment type `Contractor` with scope `assignable`. Never plan stakeholder contractors (Alexandre Cerqueira, Diego Arguello).
